...
const GlobalLayout: FC<{ children: ReactNode; showFooter?: boolean }> = ({
  ...
  <>
    <ScrollProgress />
    <div className="-z-50 h-[100dvh] fixed inset-0 overflow-hidden">
    ...
    <div className="relative z-10 px-4 py-3 sm:px-5 md:p-5 lg:p-6 max-w-[1280px] mx-auto min-h-screen flex flex-col min-w-0 w-full">
