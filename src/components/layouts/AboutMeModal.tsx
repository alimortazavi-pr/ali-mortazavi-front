...
const AboutMeModal: FC<aboutMeModalProps> = ({ isOpen, onClose }) => (
  <Modal isOpen={isOpen} onClose={onClose}>
    <ModalOverlay />
    <ModalContent w={"100%"} maxWidth={"650px"} rounded={"2xl"}>
      <ModalCloseButton />
      <ModalHeader>
        <span className="text-gray-100 xl:text-2xl">About Me</span>
      </ModalHeader>
      <ModalBody>
        ...
        <div className="pb-3">
          ...
          >
            <span className="!flex items-center gap-2 !py-2 md:!py-3">
              <span className="text-lg md:text-lg font-black">My Resume</span>
              <DocumentDownload
                size="20"
